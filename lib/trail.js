...
function Trail(root) {
   ...
   **/
  this.extensions = new NormalizedArray(normalize_extension);
   ...
   **/
  this.paths = new NormalizedArray(function(p) {
 ...
 **/
Trail.prototype.prepend_path = Trail.prototype.prepend_paths = function() {
 ...
 **/
Trail.prototype.append_path = Trail.prototype.append_paths = function() {
  var args = Array.isArray(arguments[0]) ? arguments[0] : arguments;
 ...
 **/
Trail.prototype.remove_path = function(path) {
 ...
 **/
Trail.prototype.prepend_extension = Trail.prototype.prepend_extensions = function() {
  var args = Array.isArray(arguments[0]) ? arguments[0] : arguments;
 ...
 **/
Trail.prototype.append_extension = Trail.prototype.append_extensions = function() {
  var args = Array.isArray(arguments[0]) ? arguments[0] : arguments;
 ...
 **/
Trail.prototype.remove_extension = function(ext) {
 ...
 **/
Trail.prototype.alias_extension = function(new_ext, old_ext) {
 ...
 **/
Trail.prototype.unalias_extension = function(ext) {
 ...
 **/
Trail.prototype.cached = function() {
