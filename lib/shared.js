...
function getOwnProperty(object, propertyName) {
...
function patternFor(self, basename) {
  if (!self.__patterns__.hasOwnProperty(basename)) {
    var pattern;

    var extname = path.extname(basename);
    var aliases = getOwnProperty(self.__aliases__, extname);
...
function sortMatches(self, matches, basename) {
  var aliases = getOwnProperty(self.__aliases__, path.extname(basename)) || [];
  var weights = {};
