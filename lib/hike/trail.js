...
/** alias of: Trail#prependPaths
 *  Trail#prependPath(*paths) -> Void
 **/
 ...
 **/
Trail.prototype.prependPath =
Trail.prototype.prependPaths = function () {
  this.paths.prepend(_.flatten(arguments));
};


/** alias of: Trail#appendPaths
 *  Trail#appendPath(*paths) -> Void
 **/
...
/** alias of: Trail#prependExtensions
 *  Trail#prependExtension(*extensions) -> Void
 **/
 ...
 **/
Trail.prototype.prependExtension =
Trail.prototype.prependExtensions = function () {
  this.extensions.prepend(_.flatten(arguments));
};


/** alias of: Trail#appendExtensions
 *  Trail#appendExtension(*extensions) -> Void
 **/
 ...
 **/
Trail.prototype.appendExtension =
